      ...
      <div class="modal-body">
        <div class="row mb-4">
          <div class="col">
            ...
            <p>Repository: <a href="https://github.com/anshori/leaflet-crud-mysql-laravel" target="_blank"
                rel="noopener noreferrer">https://github.com/anshori/leaflet-crud-mysql-laravel</a> </p>
            ...
            <ul>
              <li><a href="https://github.com/anshori/leaflet-crud-mysql-ci4" target="_blank"
                  rel="noopener noreferrer">https://github.com/anshori/leaflet-crud-mysql-ci4</a></li>
              <li><a href="https://github.com/andyprasetya/leaflet-CRUD" target="_blank"
                  rel="noopener noreferrer">https://github.com/andyprasetya/leaflet-CRUD</a></li>
            </ul>
            <p class="mb-0">Training:</p>
            <ul class="list-unstyled ms-3">
              <li><a href="https://sinaugis.com" target="_blank" rel="noopener noreferrer"
                  class="text-decoration-none"><i class="bi bi-globe-central-south-asia"></i> https://sinaugis.com</a>
              </li>
              <li><a href="https://wa.me/0895421712737" target="_blank" rel="noopener noreferrer"
                  class="text-decoration-none"><i class="bi bi-whatsapp"></i> 0895421712737</a></li>
              <li><a href="mailto:sinaugis@gmail.com" target="_blank" rel="noopener noreferrer"
                  class="text-decoration-none"><i class="bi bi-envelope"></i> sinaugis@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
